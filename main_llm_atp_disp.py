...
from hypernet_llm import LLM_HyperStructure, LLM_HyperStructure_v2
...
def main():
    ...
    hyper_net = LLM_HyperStructure_v2(p_structure = p_structures, T = 0.2, base = 3, args = args).to(device)#.to(dtype=torch.bfloat16).to(device)
