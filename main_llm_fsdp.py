...
parser.add_argument('--control-epochs', default=2, type=int,
...
def main():
    ...
    hyper_net_ddp   = FSDP(hyper_net,device_ids=device, use_orig_params=True, mixed_precision=mixed_precision_policy)
